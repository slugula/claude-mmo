...
//   verb (white) + subject (orange) — shadow pass + color pass + dark bg box.
...
static constexpr Clay_Color kShadow  = {   0.f,   0.f,   0.f, 180.f };
static constexpr Clay_Color kDarkBg  = {   0.f,   0.f,   0.f, 140.f };
